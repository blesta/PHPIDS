...
{
    public const FILENAME_RULES = "default_filter.xml";
    public const FILENAME_CONVERTER = "Converter.php";

    /**
     * Url returns SHA-1 Hash of the current version
     * @var string
     */
    public const HASH_BASE_URL = "https://phpids.org/hash.php?f=";

    /**
     * The base url of the rules and converter file
     * @var string
     */
    public const DOWNLOAD_BASE_URL = "https://dev.itratos.de/projects/php-ids/repository/raw/trunk/lib/IDS/";

    /**
     * Base URL for retreiving last modification information. %s -> filename
     * @var string
     */
    public const FEED_BASE_URL = "http://dev.itratos.de/projects/php-ids/repository/revisions/1/revisions/trunk/%s?format=atom";
